...
from compression.postfactorizedmodel import PostFactorizedModel
from configuration import GeneralConfig as gconfig, TrainConfig as tconfig, DecodeConfig as dconfig, CompressionConfig as cconfig
